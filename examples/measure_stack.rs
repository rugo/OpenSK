...
fn write_result(console: &mut Console, text: &str, size: u32) {
    writeln!(console, "{}, {}", text, size).unwrap();
}
...
fn main() {
    ...
    write_result(&mut console, "bench::keygen_hybrid", main_end - min_address3);
//    write_result(&mut console, "      sign_ecdsa", main_end - min_address4);
//    write_result(&mut console, "  sign_dilithium", main_end - min_address5);
    write_result(&mut console, "bench::sign_hybrid", main_end - min_address6);
    write_result(&mut console, "bench::test_dummy", main_end - min_address7);
    write_result(&mut console, "bench::test_input", main_end - min_address8);
